package com.wiernisobie.application.views.memberlist;
...
@Route(value = "member-list", layout = MainLayout.class)
@PermitAll
public class MemberListView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public MemberListView() {
        addClassName("member-list-view");
        setSizeFull();
        grid.setHeight("100%");
